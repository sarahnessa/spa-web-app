...
const clinicians = [
  ...
  },
  {
    ...
    photo:
      "https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=400&h=500&fit=crop&auto=format",
  ...
  },
  {
    ...
    photo:
      "https://images.unsplash.com/photo-1500048993953-d23a436266cf?w=400&h=500&fit=crop&auto=format",
  ...
  },
  {
    ...
    photo:
      "https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=400&h=500&fit=crop&auto=format",
...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About Us | Serenova Spa</title>
        <meta name="description" content="Meet the team at Serenova Spa." />
        <meta property="og:title" content="About Us | Serenova Spa" />
      ...
      <div className="overflow-hidden">
        ...
        <section className="relative py-24 text-center overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto px-6">
            ...
            <h1
              className="font-serif text-5xl font-semibold mb-6"
            ...
            >
              Each of our clinicians brings years of specialized training and a
              genuine dedication to the art of therapeutic care. They work
              slowly, listen deeply, and tailor every session to you.
            </p>
          </div>
        </section>
        ...
        >
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <p
              ...
              style={{ color: "var(--muted-foreground)" }}
            >
              Every session at Serenova begins with listening. We believe
              healing is not something done to a body — it is something that
              happens within, when conditions of safety, warmth, and intention
              are present.
            </p>
          </div>
        </section>
